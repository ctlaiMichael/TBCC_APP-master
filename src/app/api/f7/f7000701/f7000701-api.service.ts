...
import { F7000701ResBody } from './f7000701-res';
import { F7000701ReqBody } from './f7000701-req';
...
@Injectable()
export class F7000701ApiService extends ApiBase<F7000701ReqBody, F7000701ResBody> {
	constructor(
		public telegram: TelegramService<F7000701ResBody>,
		public errorHandler: HandleErrorService,
		public authService: AuthService,
		private _formateService: FormateService) {
		super(telegram, errorHandler, 'F7000701');
	}
	...
	saveData(reqObj, security: any): Promise<any> {
		...
		return this.send(data, reqHeader).then(
			(jsonObj) => {
				...
				const modify_data = TaxApiUtil.modifyResultResponse(jsonObj, 'F7000701');
