...
import { F7000501ResBody } from './f7000501-res';
import { F7000501ReqBody } from './f7000501-req';
...
@Injectable()
export class F7000501ApiService extends ApiBase<F7000501ReqBody, F7000501ResBody> {
	constructor(
		public telegram: TelegramService<F7000501ResBody>,
		public errorHandler: HandleErrorService,
		public authService: AuthService,
		private _formateService: FormateService) {
		super(telegram, errorHandler, 'F7000501');
	}
	saveData(reqObj, security: any): Promise<any> {
		...
		return this.send(data, reqHeader).then(
			(jsonObj) => {
				...
				const modify_data = TaxApiUtil.modifyResultResponse(jsonObj, 'F7000501');
