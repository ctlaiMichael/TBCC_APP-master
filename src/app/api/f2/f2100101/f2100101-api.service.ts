...
import { F2100101ResBody } from './f2100101-res';
import { F2100101ReqBody } from './f2100101-req';
...
@Injectable()
export class F2100101ApiService extends ApiBase<F2100101ReqBody, F2100101ResBody> {
    constructor(
        public telegram: TelegramService<F2100101ResBody>,
        public errorHandler: HandleErrorService,
        public authService: AuthService,
        private _logger: Logger,
        private _formateService: FormateService
    ) {
        super(telegram, errorHandler, 'F2100101');
    }
  ...
  getPageData(req: object, page?: number, sort?: Array<any>, pageSize?: string | number): Promise<any> {
        ...
        // 參數處理
        let data: F2100101ReqBody = new F2100101ReqBody();
