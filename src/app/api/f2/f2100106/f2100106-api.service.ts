...
import { F2100106ResBody } from './f2100106-res';
import { F2100106ReqBody } from './f2100106-req';
...
@Injectable()
export class F2100106ApiService extends ApiBase<F2100106ReqBody, F2100106ResBody> {
    constructor(
        public telegram: TelegramService<F2100106ResBody>,
        public errorHandler: HandleErrorService,
        public authService: AuthService,
        private _logger: Logger,
        private _formateService: FormateService
    ) {
        super(telegram, errorHandler, 'F2100106');
    }
    ...
    getData(req): Promise<any> {
        ...
        // 參數處理
        let data: F2100106ReqBody = new F2100106ReqBody();
        ...
        return this.send(data).then(
            (resObj) => {
                ...
                let modify_data = ContentSummaryApiUtil.modifyTW(resObj, 'F2100106');
