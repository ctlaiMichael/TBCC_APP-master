...
import { F2000201ResBody } from './f2000201-res';
import { F2000201ReqBody } from './f2000201-req';
...
@Injectable()
export class F2000201ApiService extends ApiBase<F2000201ReqBody, F2000201ResBody> {
    constructor(
        public telegram: TelegramService<F2000201ResBody>,
        public errorHandler: HandleErrorService,
        public authService: AuthService,
        private _formateService: FormateService
    ) {
        super(telegram, errorHandler, 'F2000201');
    }
    ...
    getPageData(page?: number, sort?: Array<any>, background?: boolean, pageSize?: string | number): Promise<any> {
        ...
        let data: F2000201ReqBody = new F2000201ReqBody();
