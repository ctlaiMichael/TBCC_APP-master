...
import { F2100103ResBody } from './f2100103-res';
import { F2100103ReqBody } from './f2100103-req';
...
@Injectable()
export class F2100103ApiService extends ApiBase<F2100103ReqBody, F2100103ResBody> {
    constructor(
        public telegram: TelegramService<F2100103ResBody>,
        public errorHandler: HandleErrorService,
        public authService: AuthService,
        private _formateService: FormateService,
        private _logger: Logger,
    ) {
        super(telegram, errorHandler, 'F2100103');
    }
    ...
    getData(req): Promise<any> {
        ...
        // 參數處理
        let data: F2100103ReqBody = new F2100103ReqBody();
        ...
        return this.send(data).then(
            (resObj) => {
                ...
                let modify_data = ContentSummaryApiUtil.modifyTW(resObj, 'F2100103');
