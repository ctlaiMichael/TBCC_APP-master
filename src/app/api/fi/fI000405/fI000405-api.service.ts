...
import { FI000405ResBody } from './fI000405-res';
import { FI000405ReqBody } from './fI000405-req';
...
@Injectable()
export class FI000405ApiService extends ApiBase<FI000405ReqBody, FI000405ResBody> {
  constructor(
    public telegram: TelegramService<FI000405ResBody>,
    public errorHandler: HandleErrorService,
    public authService: AuthService,
    private _formateService: FormateService,
    private _logger: Logger
  ) {
    super(telegram, errorHandler, 'FI000405');
  }
  ...
  getData(req: any): Promise<any> {
    ...
    const data = new FI000405ReqBody();
