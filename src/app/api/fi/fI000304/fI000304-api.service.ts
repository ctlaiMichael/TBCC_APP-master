...
import { FI000304ResBody } from './FI000304-res';
import { FI000304ReqBody } from './FI000304-req';
...
@Injectable()
export class FI000304ApiService extends ApiBase<FI000304ReqBody, FI000304ResBody> {
	constructor(
		public telegram: TelegramService<FI000304ResBody>,
		public errorHandler: HandleErrorService,
		public authService: AuthService,
		private _formateService: FormateService
	) {
		super(telegram, errorHandler, 'FI000304');
	}
	...
	getData(req: object, page?: number, sort?: Array<any>): Promise<any> {
		...
		const data = new FI000304ReqBody();
