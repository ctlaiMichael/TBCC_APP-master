...
import { FI000508ResBody } from './FI000508-res';
import { FI000508ReqBody } from './FI000508-req';
...
@Injectable()
export class FI000508ApiService extends ApiBase<FI000508ReqBody, FI000508ResBody> {
  constructor(
    public telegram: TelegramService<FI000508ResBody>,
    public errorHandler: HandleErrorService,
    public authService: AuthService,
    private _formateService: FormateService,
    private _logger: Logger
  ) {
    super(telegram, errorHandler, 'FI000508');
  }
  ...
  getData(req: object, page?: number, sort?: Array<any> , reqHeader?: any): Promise<any> {
    ...
    this._logger.step('FUND', 'new FI000508ReqBody2');
    const data = new FI000508ReqBody();
