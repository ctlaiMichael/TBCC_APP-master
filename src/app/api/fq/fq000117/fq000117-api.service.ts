...
import { FQ000117ReqBody } from './fq000117-req';
import { FQ000117ResBody } from './fq000117-res';
...
@Injectable()
export class FQ000117ApiService extends ApiBase<FQ000117ReqBody, FQ000117ResBody> {

    constructor(
        public telegram: TelegramService<FQ000117ResBody>,
        public errorHandler: HandleErrorService,
        public authService: AuthService,
        private _formateService: FormateService
    ) {
        super(telegram, errorHandler, 'FQ000117');
    }
    ...
    sendData(set_data: Object, token: string, security: any): Promise<any> {
        ...
        let df_data: FQ000117ReqBody = new FQ000117ReqBody();
