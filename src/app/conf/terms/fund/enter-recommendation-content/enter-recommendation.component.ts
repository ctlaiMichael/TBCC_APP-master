...
@Component({
    selector: 'app-enter-recommendation',
    templateUrl: './enter-recommendation.component.html',
    styleUrls: [],

})
export class EnterRecommendationComponent implements OnInit {
    /**
     * 參數處理
     */
    ...
    onErrorBackEvent(error_obj) {
        ...
        this._logger.error('HomePage', 'fund', error_obj);
