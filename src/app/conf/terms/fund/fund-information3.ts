...
export class FundInformation3 extends InfomationOptions {
    title?: string;     // 自定標題
    ...
    constructor() {
        super();
        this.title = '「0163-景順英國債券基金英鎊」基金通路報酬揭露資訊';
    ...
    private _initData() {
        ...
        this.content = `
            ...
            一、 基金名稱 ：「0163-景順英國債券基金英鎊」 二、 基金種類 ：股票型 三、 基金投資方針 ：請參閱本基金公開說明書【基金概況】 四、 基金型態 ：開放式基金 五、 基金投資地區 ：本基金投資國內外
