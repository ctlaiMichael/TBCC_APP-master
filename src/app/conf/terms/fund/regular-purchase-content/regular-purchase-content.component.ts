...
@Component({
    selector: 'app-regular-purchase-content',
    templateUrl: './regular-purchase-content.component.html',
    styleUrls: [],

})
export class RegularPurchaseContentComponent implements OnInit {
    /**
     * 參數處理
     */
