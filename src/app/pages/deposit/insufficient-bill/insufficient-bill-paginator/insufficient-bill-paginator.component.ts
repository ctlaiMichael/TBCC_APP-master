...
@Component({
  selector: 'app-insufficient-bill-paginator',
  templateUrl: './insufficient-bill-paginator.component.html',
  providers: [InsufficientBillService]
})
export class InsufficientBillPaginator implements OnInit {
  /**
   * 參數處理
   */
