...
import { OverviewPaginatorComponent } from './overview-paginator/overview-paginator.component';
import { DepositInquiryService } from '@pages/deposit/shared/service/deposit-inquiry.service';

@Component({
    selector: 'app-overview-mainpage',
    templateUrl: './overview-mainpage.component.html',
    providers: [DepositInquiryService]
})
export class OverviewMainPageComponent implements OnInit {
    /**
     * 參數處理
     */
    ...
    onScrollEvent(next_page) {
        ...
        let componentRef: any = this.paginatorCtrl.addPages(this.pageBox, OverviewPaginatorComponent);
