...
// == 分頁 End == //
import { DayRemitListPaginatorComponent } from './day-remit-list-paginator/day-remit-list-paginator.component';
@Component({
	selector: 'app-day-remit-list-mainpage',
	templateUrl: './day-remit-list-mainpage.component.html',
	providers: []
})
export class DayRemitListMainPageComponent implements OnInit {
	/**
	 * 參數處理
	 */
	...
	onScrollEvent(next_page) {
		...
		let componentRef: any = this.paginatorCtrl.addPages(this.pageBox, DayRemitListPaginatorComponent);
