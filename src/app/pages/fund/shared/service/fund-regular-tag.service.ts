...
export class FundRegularTagService {
    /**
     * 參數處理
     */
    ...
    getBookmark() {
        ...
        detail_data.push({
            id: '1M',
            name: 'BOOK_MARK.FUND_PURCHASE.1M', // 近1月
            sort: 2,
            ...
            detail_data.push({
                id: '3M',
                name: 'BOOK_MARK.FUND_PURCHASE.3M', // 近3月
                sort: 3,
        ...
        //     detail_data.push({
        //         id: '6M',
        //         name: 'BOOK_MARK.FUND_PURCHASE.6M', // 近6月
        //         sort: 5,
        ...
        // detail_data.push({
        //     id: 'custom',
        //     name: 'BOOK_MARK.FUND_PURCHASE.CUSTOM', // 自訂
        //     sort: 4,
        //     search_data: this.setDateCheck('custom')
        // });
        output.push({
            id: 'summary',
            name: 'BOOK_MARK.COMMON.REGULAR_QUOTA', // 定期定額
            sort: 1
        });
        output.push({
            id: 'detail',
            name: 'BOOK_MARK.COMMON.REGULAR_NOT_QUOTA', // 定期不定額
            sort: 2,
            default: '1M',
            data: detail_data
        });
