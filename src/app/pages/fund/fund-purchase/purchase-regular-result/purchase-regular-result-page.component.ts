...
@Component({
    selector: 'app-purchase-regular-result',
    templateUrl: './purchase-regular-result-page.component.html',
    styleUrls: [],
    providers: [FundPurchaseRegularService]
})
export class PurchaseRegularResultPageComponent implements OnInit {
    /**
      * 參數處理
      */
    ...
    ngOnInit() {
        ...
        this._mainService.getPurchase_Result(this.reqData, this.e).then(
            (result) => {
                ...
                this._logger.log("info_data.salesId:",this.info_data.salesId);
                this._logger.log("info_data.introId:",this.info_data.introId);
