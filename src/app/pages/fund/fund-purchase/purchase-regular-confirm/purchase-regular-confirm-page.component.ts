...
@Component({
    selector: 'app-purchase-regular-confirm',
    templateUrl: './purchase-regular-confirm-page.component.html',
    styleUrls: [],
    providers: []
})
export class PurchaseRegularConfirmPageComponent implements OnInit {
    /**
      * 參數處理
      */
    ...
    ngOnInit() {
        this._logger.log("purchaseInfo:",this.purchaseInfo);
        this._logger.log("purchaseInfo.salesID:",this.purchaseInfo.salesID);
        this._logger.log("purchaseInfo.introID:",this.purchaseInfo.introID);
        this._logger.log("purchaseInfo.salesId:",this.purchaseInfo.salesId);
        this._logger.log("purchaseInfo.introId:",this.purchaseInfo.introId);
        this._checkReqData();
