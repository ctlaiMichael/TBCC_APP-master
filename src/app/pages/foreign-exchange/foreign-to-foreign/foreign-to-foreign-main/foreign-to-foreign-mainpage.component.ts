...
@Component({
    selector: 'app-foreign-to-foreign-mainpage',
    templateUrl: './foreign-to-foreign-mainpage.component.html',
    providers: []
})
export class ForeignToForeignMainComponent implements OnInit {
    /**
     * 參數處理
     */
    fromPage: string;
