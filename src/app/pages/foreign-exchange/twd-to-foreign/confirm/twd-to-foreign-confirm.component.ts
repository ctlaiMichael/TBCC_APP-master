...
@Component({
    selector: 'app-twd-to-foreign-confirm',
    templateUrl: './twd-to-foreign-confirm.component.html',
    styleUrls: [],
    providers: []
})
export class TwdToForeignConfirmComponent implements OnInit {
    ...
    stepBack(e) {
        ...
        if (this.formObj.isReservation) {
            ...
            signObj = {
                ...
                //this._formateService.transDate(data.trnsfrDate, { formate: 'yyyMMdd', chinaYear: true });
