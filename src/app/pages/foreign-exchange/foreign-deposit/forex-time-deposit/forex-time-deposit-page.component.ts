...
@Component({
    selector: 'app-forex-time-deposit-page',
    templateUrl: './forex-time-deposit-page.component.html',
    styleUrls: [],

})
export class ForexTimeDepositPageComponent implements OnInit {
    /**
     * 參數處理
     */
    @Input() acctObj: any;
    ...
    onScrollEvent(next_page) {
        ...
        switch (this.nowPageType) {
            ...
            case '6M': appendBox = this.pageBox2; break;
            case '12M': appendBox = this.pageBox3; break;
        ...
        let componentRef: any = this.paginatorCtrl.addPages(appendBox, ForexTimePaginatorComponent);
    ...
    */
    ...
    private _initEvent() {
        ...
        // 查詢頁面說明事項
        this.searchInfoData = [
            // 輸入查詢之起始日期及終止日期，外幣活期性存款可查詢本月及一年內資料。
            // 4/24/需求變更可查詢一年之資料
            'PG_DEPOSIT.FOREX_DEPOSIT.SEARCH_INFO.INFO2','PG_DEPOSIT.FOREX_DEPOSIT.SEARCH_INFO.INFO3'
        ];
    }
