...
import { GoldBusinessSharedRoutingModule } from '@pages/gold-business/shared/gold-business-shared-routing.module';
...
@NgModule({
    imports: [
        SharedModule,
        EffectCubeModule,
        //GoldBusinessSharedRoutingModule
    ],
    exports: [
        // // RouterModule
        CertifyComponent,
...
export class GoldBusinessSharedModule {
    constructor(
    ) {
    }
}
