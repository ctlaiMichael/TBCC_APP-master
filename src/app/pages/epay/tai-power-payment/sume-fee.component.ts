...
@Component({
  selector: 'app-sume-fee',
  templateUrl: './sume-fee.component.html',
  styleUrls: ['./sume-fee.component.css']
})
export class SumeFeeComponent implements OnInit {
          ...
          resSecurityInfo => {
            ...
            this.fq000502.send(FQ000502req, reqHeader).then(
              (resfq000502) => {
                ...
                this.navgator.push('eFeeResult', this.returnData[0]);
              },
              (error) => {
