...
@Component({
  selector: 'app-tai-power-payment-card',
  templateUrl: './tai-power-payment-card.component.html',
  styleUrls: ['./tai-power-payment-card.component.css']
})
export class TaiPowerPaymentCardComponent implements OnInit {
  agreeChecked = false;
  ...
  gotoSumeFee() {
    ...
    this.navgator.push('cardlogin-taipowerSumFee', [this.electricinfoData, this.electricityFeePrepay]);
  }
