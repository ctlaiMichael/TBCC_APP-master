...
@Component({
  selector: 'app-efee-result-card',
  templateUrl: './efee-result-card.component.html',
  styleUrls: ['./efee-result-card.component.css']
})
export class EfeeResultCardComponent implements OnInit {
