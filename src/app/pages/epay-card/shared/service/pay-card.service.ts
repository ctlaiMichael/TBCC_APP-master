...
export class PayCardService {
    ...
    async sendData(set_data, selectSecurityType, meansTransactionCard, cardNbr): Promise<any> {
        ...
        this._logger.step('Epay-card', 'paycart start', this._formateService.transClone(set_data));
        try {
            this._logger.step('Epay-card', 'paycart start token');
            let transToken = await this.qrtype.getTrnsToken();
            this._logger.step('Epay-card', 'token success', transToken);
            ...
            // this._logger.step('Epay-card', 'fq000107 success', resObj, set_data);
            ...
            if (meansTransactionCard == true) {
                ...
                this._logger.step('Epay-card', 'security success', resSecurityInfo1);
                let resObj1 = await this.fq000117.sendData(set_data, transToken, resSecurityInfo1);
                this._logger.step('Epay-card', 'fq000117 success', resObj1, set_data);
                ...
                this._logger.step('Epay-card', 'security success', resSecurityInfo);
                let resObj = await this.fq000107.sendData(set_data, transToken, resSecurityInfo);
                this._logger.step('Epay-card', 'fq000107 success', resObj, set_data);
                outputRes = this._modifyResp(resObj, set_data);
            }
    ...
    private _modifyResp(resObj, set_data) {
        this._logger.step('Epay-card', 'res modify', resObj);
