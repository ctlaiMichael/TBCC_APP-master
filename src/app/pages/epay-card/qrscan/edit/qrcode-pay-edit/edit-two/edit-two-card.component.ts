...
@Component({
  selector: 'app-edit-two-card',
  templateUrl: './edit-two-card.component.html',
  styleUrls: ['./edit-two-card.component.css']
})
export class EditTwoCardComponent implements OnInit {
