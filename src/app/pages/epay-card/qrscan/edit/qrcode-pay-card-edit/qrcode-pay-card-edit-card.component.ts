...
@Component({
	selector: 'app-qrcode-pay-card-edit-card',
	templateUrl: './qrcode-pay-card-edit-card.component.html',
	styleUrls: ['./qrcode-pay-card-edit-card.component.css']
})
export class QrcodePayCardEditCardComponent implements OnInit {
