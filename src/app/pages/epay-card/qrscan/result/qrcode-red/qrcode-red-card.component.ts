...
@Component({
    selector: 'app-qrcode-red-card',
    templateUrl: './qrcode-red-card.component.html',
    styleUrls: ['./qrcode-red-card.component.css'],
    providers: [SocialsharingPluginService]
})
export class QrcodeRedCardComponent implements OnInit {
