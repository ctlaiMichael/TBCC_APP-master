...
@Component({
  selector: 'app-show-receipt-card',
  templateUrl: './show-receipt-card.component.html',
  styleUrls: ['./show-receipt-card.component.css']
})


export class ShowReceiptCardomponent implements OnInit {
