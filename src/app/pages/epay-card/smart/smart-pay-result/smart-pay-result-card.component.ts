...
@Component({
  selector: 'app-smart-pay-result-card',
  templateUrl: './smart-pay-result-card.component.html',
  styleUrls: ['./smart-pay-result-card.component.css']
})
export class SmartPayResultCardComponent implements OnInit {
  ...
  qrcode() {
    this.navgator.push('cardlogin-epay-scan');
  }
