...
@Component({
  selector: 'app-smart-pay-card',
  templateUrl: './smart-pay-card.component.html',
  styleUrls: ['./smart-pay-card.component.css']
})
export class SmartPayCardComponent implements OnInit {
  ...
  submit() {
    ...
    this.fq000103.send(this.formPaySetting).then(
      resfq000103 => {
        ...
        this.navgator.push('cardlogin-qrcodePaySettingResult', {}, params.result.body);
      },
      errorfq000103 => {
