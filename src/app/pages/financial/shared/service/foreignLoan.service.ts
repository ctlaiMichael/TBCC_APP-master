...
import { FB000105ReqBody } from '@api/fb/fb000105/fb000105-req';
import { CacheService } from '@core/system/cache/cache.service';
@Injectable()
export class ForeignLoanService {
    /**
     * 參數處理
     */
    ...
    constructor(
        ...
        , private fb000105: FB000105ApiService
    ...
    public getData(option?: Object): Promise<any> {
        ...
        let req_data = new FB000105ReqBody();
        return this.fb000105.send(req_data).then(
            (jsonObj) => {
                let output = jsonObj;
