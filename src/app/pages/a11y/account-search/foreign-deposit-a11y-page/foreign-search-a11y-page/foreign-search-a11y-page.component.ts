...
import { DateMonth } from '../../taiwan-deposit-a11y-page/search-a11y-page/Dateobject';
...
@Component({
  selector: 'app-foreign-search-a11y-page',
  templateUrl: './foreign-search-a11y-page.component.html',
})
export class ForeignSearchA11yPageComponent implements OnInit {

  /**
  * 參數設定
  */
  // ---------------------reference overview-content
  @Input() acctObj        // 接收父層資料
  ...
  headerObj = {
    ...
    rightBtnIcon: 'noshow',
    title: '外匯存款查詢',
    backPath: 'a11yforeigndepositkey',
  };
  ...
  */
  ...
  gobackPage() { // 左邊button
    ...
    this.navgator.push('a11yforeigndepositkey', params);
