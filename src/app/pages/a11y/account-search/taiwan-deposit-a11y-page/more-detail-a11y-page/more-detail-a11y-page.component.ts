...
@Component({
  selector: 'app-more-detail-a11y-page',
  templateUrl: './more-detail-a11y-page.component.html',
  // styleUrls: ['./more-detail-a11y-page.component.css']
})
export class MoreDetailA11yPageComponent implements OnInit {
