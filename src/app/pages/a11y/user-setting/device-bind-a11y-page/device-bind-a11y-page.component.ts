...
@Component({
    selector: 'app-device-bind-a11y',
    templateUrl: './device-bind-a11y-page.component.html'
})
export class DeviceBindA11yPageComponent implements OnInit {
    /**
     * 參數處理
     */
    result =
    ...
    ngOnInit() {
        ...
        this._mainService.checkAuth().then(
            ...
            (errorObj) => {
                ...
                if(errorObj.classType=='success'){
                    errorObj['pageType'] = 'success';
                    errorObj['title'] = '完成裝置認證';

                }else{
                    errorObj['pageType'] = 'warning';
                }
               
                // this.result.changenameresult = 'success';
                // this.result.header =  errorObj.title?:;
                // this.result.msg = errorObj['msg'];
