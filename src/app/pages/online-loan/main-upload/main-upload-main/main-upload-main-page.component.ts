...
@Component({
    selector: 'app-main-upload-main',
    templateUrl: './main-upload-main-page.component.html',
    styleUrls: [],
    providers: [PaginatorCtrlService]
})
export class MainUploadMainPageComponent implements OnInit {
    /**
     * 參數處理
     */
        ...
        if (pageType == 'go') {
            switch (page) {
                case 'searchPage': //查詢頁點擊上傳(返回) go
                    ...
                    break;
                case 'editPage': //編輯頁go
                    this.onChangePage('resultPage'); //進結果頁
                    break;
                default:
                    this.onChangePage('queryPage');
            }
