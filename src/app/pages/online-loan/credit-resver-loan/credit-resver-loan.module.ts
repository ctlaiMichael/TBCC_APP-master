...
import { CreditResverLoanRoutingModule } from './credit-resver-loan-routing.module';
...
@NgModule({
  ...
  declarations: [
    // ---------------- Pages Start ---------------- //
    CreditResverLoanMainComponent //主頁
  ]
})
export class CreditResverLoanModule { }
