...
@Component({
    selector: 'app-credit-resver-loan-main',
    templateUrl: './credit-resver-loan-main.component.html',
    styleUrls: [],
    providers: [PaginatorCtrlService]
})

export class CreditResverLoanMainComponent implements OnInit {
    ...
    ngOnInit() {
        this._logger.log("into credit-resver-main page");
        //重置全部暫存資料
        this.restAllData();
