...
import { MortgageIncreaseRoutingModule } from './mortgage-increase-routing.module';
...
@NgModule({
  ...
  declarations: [
    // ---------------- Pages Start ---------------- //
    MortgageMainComponent //主頁
  ]
})
export class MortgageIncreaseModule { }
