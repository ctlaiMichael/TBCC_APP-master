 ...
 */
	...
	checkPage6() {
		...
		//現職服務年資
		this.reqData.serverdur = '';
		//現職服務年資(月)
		this.reqData.serverdurMm = '';
		//行業別   
		this.reqData.applyTrade = '';
		//職業別細項    
		this.reqData.metier = '';
		//職業別分項
	...
	checkPage7() {
		...
		//全過
		if (this.checkError.check_applyNt == false && this.checkError.error_mYear == '') {
			output.status = true;
			output.msg = 'success';
		} else {
			output.status = false;
