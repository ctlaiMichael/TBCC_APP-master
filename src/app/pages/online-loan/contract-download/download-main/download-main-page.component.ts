...
@Component({
    ...
    templateUrl: './download-main-page.component.html',
    styleUrls: [],
    providers: [PaginatorCtrlService]
})
export class DownloadMainPageComponent implements OnInit {
   /**
     * 參數處理
     */
    ...
    ngOnInit() {
        this._logger.log("into sign main page");
    ...
    onPageBackEvent(e) {
        ...
        if(page =='download-search' && pageType=='go-download') {
            this._logger.log("into goDownload back main");
            this.fullData = tmp_data;
            this.showPage = 'detail-pages';
        }
    }
    ...
    onScrollEvent(next_page) {
        ...
        const componentRef: any = this.paginatorCtrl.addPages(this.pageBox, DownloadSearchPageComponent);
