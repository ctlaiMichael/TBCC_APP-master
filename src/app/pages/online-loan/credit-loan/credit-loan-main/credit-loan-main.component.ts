...
@Component({
    selector: 'app-credit-loan-main',
    templateUrl: './credit-loan-main.component.html',
    styleUrls: [],
    providers: [PaginatorCtrlService]
})

export class CreditLoanMainComponent implements OnInit {
            ...
            if (pageType == 'go') {
                ...
                switch (page) {
                    ...
                    case 'contact-branch': //選擇分行(回傳) Go
                        ...
                        this.onChangePage('file-upload'); //前往文件上傳
                        break;
                ...
                switch (page) {
                    ...
                    case 'file-upload': //文件上傳(回傳) Back
                        ...
                        this.fullData = tmp_data;
                        this.action = 'back';
                        this.onChangePage("contact-branch");
                        break;
                }
            } else {
                this._logger.log("into type another");
                switch (page) {
