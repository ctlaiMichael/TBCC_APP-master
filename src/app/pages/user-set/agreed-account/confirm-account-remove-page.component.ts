...
@Component({
    selector: 'app-confirm-account-remove-page',
    templateUrl: './confirm-account-remove-page.component.html',
    styleUrls: [],
    providers: []
})
/**
  * 註銷確認頁
  */
export class ConfirmAccRemovePageComponent implements OnInit {
        ...
        if (e.status) {
            ...
            if (e.securityType === '3') {
                ...
                e.signText = {
                    ...
                    'bank': this.editData.trnsInBank,
                    'account': this.editData.trnsInAccnt
                };
            };;
            // 統一叫service 做加密
