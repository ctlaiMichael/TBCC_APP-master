...
@Component({
    selector: 'app-confirm-account-add-page',
    templateUrl: './confirm-account-add-page.component.html',
    styleUrls: [],
    providers: []
})
/**
  * 
  */
export class ConfirmAccAddPageComponent implements OnInit {
        ...
        if (e.status) {
            ...
            if (e.securityType === '3') {
                ...
                e.signText = {
                    ...
                    'bankNo': this.editData.bankNo,
                    'accountNo': this.editData.accountNo.replace(/-/g, ''),
                    'accountNickName': this.editData.accountNickName,
