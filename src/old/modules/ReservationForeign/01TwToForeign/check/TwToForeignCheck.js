...
define([
	...
	//=====[ START]=====//
	MainApp.register.controller('TwToForeignCheckCtrl',
		function (
			...
			function getF5000105() {
				...
				$log.debug("f5000105 res:" + JSON.stringify(res));
					if (res) {
						...
						$state.go('TwToForeignResult',params,{location: 'replace'});
