...
define([
	...
	,"app_telegram/fc001301Telegram"
	,"app_telegram/fc000102Telegram"
]
, function (MainApp) {

//=====[billServices START 帳單分期相關]=====//
MainApp.register.service("licenseServices",function(
	i18n
	,messageServices,formServices
	,fc001301Telegram,fc000102Telegram
){
	var MainClass = this;
	...
	var error_btn = {
		...
		//帳單分期
		bill : {'name':i18n.getStringByTag('PAGE_TITLE.LICENSEINST'),'sref':'licenseInst'}
	};
	var errorCode = {};
	...
	this.getBillOptions = function(return_array){
		var data = {
			...
			'6' : {
				name: '6期/年利率0%(合庫E Pay或台灣行動支付APP掃碼獨享)',
				value: '6',
				avg : 6
			},
			'9' : {
	...
	this.sendData = function(sendData,endMethod){
		...
		fc001301Telegram.getData(sendData,getCallBack_method);
	}
});
