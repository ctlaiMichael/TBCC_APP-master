define([], function() {
    ...
    Nfc.prototype.init = function() {
        ...
        document.addEventListener('deviceready', handleNfcFromIntentFilter, false);
            ...
            smartPoster: function (ndefRecords, id) {
                ...
                if (ndefRecords)
                {
                    ...
                    alert("WARNING: Expecting an array of NDEF records");
                }
        ...
        nfc.addTagDiscoveredListener= function (callback, win, fail) {
            document.addEventListener("tag", callback, false);
            cordova.exec(win, fail, "NfcPlugin", "registerTag", []);
        };

        nfc.addMimeTypeListener= function (mimeType, callback, win, fail) {
        ...
        var textHelper = {
            ...
            decodePayload: function (data) {
                ...
                // alert("lang " + languageCode + (utf16 ? " utf16" : " utf8"));
