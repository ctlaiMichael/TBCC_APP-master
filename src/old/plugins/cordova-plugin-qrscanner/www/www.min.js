...
return {
  ...
  readQRCodeFromImage: function(successCallback, errorCallback, base64Img) {
    cordova.exec(successCallback, errorCallback, 'QRScanner', 'readQRCodeFromImage', [base64Img]);
  }
};
};
